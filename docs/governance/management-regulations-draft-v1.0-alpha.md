...
> 交叉引用：白皮书 [`../whitepaper/linkrsp-whitepaper-v1.0-alpha.md`](../whitepaper/linkrsp-whitepaper-v1.0-alpha.md)；可行性评估（含高频违规场景）[`../reports/feasibility-assessment-v1.0-alpha.md`](../reports/feasibility-assessment-v1.0-alpha.md) §6；工程架构 [`../engineering/architecture-v0.1.md`](../engineering/architecture-v0.1.md)。版本策略 [`versioning-policy.md`](versioning-policy.md)。
